...
Tehtävää jatketaan edellisen viikon tehtävien jälkeen, samoilla asetuksilla ja konfiguraatioilla. Ainoastaan ajoin `vagrant destroy` joka tuhosi edellisen viikon master-minion serverit, ja käynnistin ne uudestaan `vagrant up` komennolla.
...
Muokkasin tiedostoa, lisäämällä portin 2727, ja ottamalla kommentit pois muutamasta rivistä. konfiguraatiotiedostoni näytti tältä:
